...
SCENARIOS = [
    ...
    ScenarioCase(
        name="log_pge_paid__natural",
        prompt="PG&E payment 140",
        llm_fixture="unit_tests/fixtures/llm/logging_actions/log_pge_paid/log_pge_paid__natural.json",
        sheet_fixture="base_month",
        assert_fn=lambda result, repo: bool(result.replies),
    ),
    ScenarioCase(
        name="log_recology_paid__natural",
        prompt="Trash bill 95",
        llm_fixture="unit_tests/fixtures/llm/logging_actions/log_recology_paid/log_recology_paid__natural.json",
        sheet_fixture="base_month",
        assert_fn=lambda result, repo: bool(result.replies),
    ),
    ScenarioCase(
        name="log_water_paid__natural",
        prompt="Santa Rosa Water 110",
        llm_fixture="unit_tests/fixtures/llm/logging_actions/log_water_paid/log_water_paid__natural.json",
        sheet_fixture="base_month",
        assert_fn=lambda result, repo: bool(result.replies),
    ),
    ScenarioCase(
    ...
    ScenarioCase(
        name="log_savings__natural",
        prompt="set monthly savings to 300",
        llm_fixture="unit_tests/fixtures/llm/logging_actions/log_savings/log_savings__natural.json",
        sheet_fixture="base_month",
        assert_fn=lambda result, repo: (
            "monthly savings" in result.replies[0].lower()
            and repo.income.acell("E7").value == "300"
        ),
    ),
    ScenarioCase(
    ...
    ScenarioCase(
        name="query_pge_paid__natural",
        prompt="Did we pay PG&E?",
        llm_fixture="unit_tests/fixtures/llm/checking_payments/query_pge_paid/query_pge_paid__natural.json",
        sheet_fixture="base_month",
        assert_fn=lambda result, repo: "PG&E" in result.replies[0],
    ),
    ScenarioCase(
        name="query_pge_paid__short",
        prompt="pge paid?",
        llm_fixture="unit_tests/fixtures/llm/checking_payments/query_pge_paid/query_pge_paid__short.json",
        sheet_fixture="base_month",
        assert_fn=lambda result, repo: "PG&E" in result.replies[0],
    ),
    ScenarioCase(
        name="query_pge_paid__typo",
        prompt="did we pay smd?",
        llm_fixture="unit_tests/fixtures/llm/checking_payments/query_pge_paid/query_pge_paid__typo.json",
        sheet_fixture="base_month",
        assert_fn=lambda result, repo: "PG&E" in result.replies[0],
    ),
    ScenarioCase(
        name="query_recology_paid__natural",
        prompt="Did we pay the trash bill?",
        llm_fixture="unit_tests/fixtures/llm/checking_payments/query_recology_paid/query_recology_paid__natural.json",
        sheet_fixture="base_month",
        assert_fn=lambda result, repo: "Recology" in result.replies[0],
    ),
    ScenarioCase(
        name="query_water_paid__natural",
        prompt="Did we pay Santa Rosa Water?",
    ...
    ScenarioCase(
        name="query_savings__natural",
        prompt="How much have we saved this month?",
        llm_fixture="unit_tests/fixtures/llm/checking_payments/query_savings/query_savings__natural.json",
        sheet_fixture="base_month",
        assert_fn=lambda result, repo: bool(result.replies),
    ),
    # =========================================================================
