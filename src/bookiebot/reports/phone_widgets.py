...
<li><h2>Copy to Scriptable</h2><p>Install <a href="https://apps.apple.com/app/scriptable/id1405459188" target="_blank" rel="noreferrer">Scriptable</a>. In <a href="/app/expenses#settings">Settings → Widgets → Setup &amp; widgets</a>, tap <strong>Copy script</strong>. In Scriptable, tap +, paste and name it BookieBot.</p><p class="note">Already installed? Replace the code in the same script and keep its name. Current version: 1.5.</p></li>
