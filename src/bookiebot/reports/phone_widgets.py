...
<h2>Seeing “Pair this phone”?</h2><p>The script is installed, but that copy has not completed pairing. Run BookieBot inside the Scriptable app and paste a fresh setup code from Settings → Widgets. Home Screen previews cannot show the pairing prompt. If you renamed or imported another copy, select the same script you paired in Edit Widget.</p>
