...
- **Compare history:** choose a month, then open **Compare spending → Last month / Last year**. Comparisons use matching calendar days and dated recorded spending, with missing dates, scheduled subscriptions, and incomplete coverage explained. Historical availability depends on configured annual workbooks and existing monthly tabs.
