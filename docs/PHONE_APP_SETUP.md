...
- **Reimbursements:** the outstanding balance and month bars show how much is still due for each original expense month; longer bars mean more money due. **View expenses** opens one month-grouped list with the amount due or **Received** on each row, including older expenses after repayment. The current month is marked; tap a row for the complete split. Selected-month Gross paid, Your share and Received totals sit inside the same list. Those receipts apply to the selected expenses, rather than payments received during that calendar month. **Earlier expenses** combines older graph months, and incomplete records stay flagged. Receipts do not become income or change monthly spending.
