...
- **Reimbursements:** the outstanding total and bar chart show unpaid balances by original expense month across configured annual workbooks. Longer histories combine older months into **Earlier expenses**. **View expenses** opens partner balances and individual splits; the selected month’s **Expense statement** contains Received, Gross paid, Your share, and received entries. Received amounts apply to those expenses, rather than payments received during that calendar month. Incomplete records stay flagged. Older unpaid amounts do not inflate this month's spending, and receipts do not become income.
