...
export function WidgetSetupGuide({ onBack, onPair }: { onBack: () => void; onPair: () => void }) {
  ...
  return <div className="bb-widget-guide">
    ...
    <section className="bb-widget-guide-recovery" aria-label="Widget needs pairing">
      ...
      <p>First, replace your existing script with the latest code below. Earlier versions could lose their connection after pairing. Run it <strong>inside Scriptable</strong>; if asked, paste a fresh setup code.</p>
