...
- Burn Rate hover dots now match the hovered point's over/under baseline color, report chart tooltips disable wrapper position animation, and Category Mix pie labels fade in smoothly with the chart.
