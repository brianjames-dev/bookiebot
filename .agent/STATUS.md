...
0. Release the verified confirmed-repayment ledger: finish full regression gates, apply the reviewed private migration, verify expense rows/worksheet mirror, then enable the feature and inspect the live phone views. No synthetic receipts or offsets in production. Checklist 109 tracks acceptance.
